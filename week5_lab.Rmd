...
### Summary statistics and check for equal variance

Starting from penguin_f, create a summary table that groups by species and returns:
...
Orthogonal/ Type III ANOVA with the car package
